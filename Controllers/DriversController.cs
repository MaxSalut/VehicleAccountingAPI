...
namespace VehicleAccountingAPI.Controllers
{
    public class DriversController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DriverId,Name,Email,LicenseNumber")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DriverId,Name,Email,LicenseNumber")] Driver driver)
        {
